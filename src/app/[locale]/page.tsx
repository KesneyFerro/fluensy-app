...
export default function HomePage() {
  ...
  useEffect(() => {
    if (flowManagerRef.current) {
      flowManagerRef.current.setLanguage(languageConfig.language);
    }
  }, [languageConfig]);
  ...
  const generatePenguinClickTTS = async () => {
    try {
      ...
      if (language === "es") {
        voiceName = "es-ES-Standard-G";
        languageCode = "es-ES";
      } else if (language === "fr") {
        voiceName = "fr-FR-Standard-G";
        languageCode = "fr-FR";
      } else {
      ...
      const text = t.clickPenguinToStart;
            ...
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="w-10 h-10 rounded-lg bg-primary text-primary-foreground hover:bg-primary/90 transition-colors flex items-center justify-center shadow-lg cursor-pointer"
                  title={t.newChat}
                >
                        ...
                        (currentResponse?.audioContent ||
                          ...
                          <div className="mt-2 flex justify-center">
                            <button
                              ...
                              className="p-1 rounded-full bg-blue-100 hover:bg-blue-200 transition-colors disabled:opacity-50 cursor-pointer disabled:cursor-not-allowed"
                              title={t.replayAudio}
                            >
                              <Volume2
